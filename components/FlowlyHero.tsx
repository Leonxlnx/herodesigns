...
const FlowlyHero: React.FC = () => {
  ...
  // SMOOTHER PHYSICS: Adjusted for a very premium, weighted feel
  const springConfig = { damping: 50, stiffness: 120, mass: 1 };
  ...
  return (
    ...
    >
      ...
      <motion.button 
        ...
        onClick={() => navigate('/')}
        className="fixed top-4 left-4 lg:top-8 lg:left-8 z-[60] group flex items-center gap-2 px-3 py-1.5 lg:px-4 lg:py-2 rounded-full bg-black/40 border border-white/10 backdrop-blur-md text-white/50 hover:text-white hover:border-white/30 transition-all cursor-pointer shadow-xl"
      >
        <ArrowLeft size={14} className="lg:w-4 lg:h-4" />
        <span className="text-[10px] lg:text-xs font-medium uppercase tracking-wider">Back</span>
      </motion.button>

      {/* --- AMBIENT BACKGROUND --- */}
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[-10%] left-[20%] w-[80vw] h-[80vw] bg-blue-900/10 rounded-full blur-[100px] lg:blur-[150px] mix-blend-screen animate-pulse duration-[10s]" />
        <div className="absolute bottom-[-10%] right-[-5%] w-[60vw] h-[60vw] bg-indigo-900/10 rounded-full blur-[80px] lg:blur-[120px] mix-blend-screen" />
        <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-[0.03]" />
        <div className="absolute bottom-0 w-full h-[40vh] lg:h-[60vh] opacity-20 perspective-[1000px] transform-style-3d overflow-hidden">
      ...
      <motion.nav 
        ...
        className="relative z-50 w-full px-4 py-4 lg:px-8 lg:py-8 flex items-center justify-between max-w-[1600px] mx-auto"
      >
        <div className="flex items-center gap-3 cursor-pointer ml-14 lg:ml-0">
        ...
        <div className="flex items-center gap-3">
          <button className="hidden lg:block text-xs font-medium text-gray-400 hover:text-white transition-colors">Sign In</button>
          <button className="px-3 py-2 lg:px-4 lg:py-2 text-xs font-semibold text-white bg-blue-600 hover:bg-blue-500 rounded-lg shadow-lg shadow-blue-900/20 transition-all transform hover:scale-105 active:scale-95">
            Get Started
          </button>
        </div>
      </motion.nav>
      ...
      {/* --- HERO CONTENT --- */}
      <main className="flex-1 relative z-10 w-full max-w-[1600px] mx-auto px-4 lg:px-8 flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-8 lg:gap-0 pb-12 lg:pb-0 pt-4 lg:pt-0">
        
        {/* LEFT COLUMN: TEXT */}
        <div className="w-full lg:w-[45%] flex flex-col items-center lg:items-start text-center lg:text-left space-y-5 lg:space-y-8 lg:pl-12 pt-4 lg:pt-0">
           <motion.div 
           ...
           <motion.h1 
             ...
             className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-tighter leading-[1.1] text-white"
           >
             Orchestrate your <br/>
           ...
           <motion.p 
             ...
             className="text-sm sm:text-base lg:text-lg text-gray-400 leading-relaxed max-w-sm sm:max-w-lg lg:max-w-xl mx-auto lg:mx-0"
           >
           ...
           <motion.div 
             ...
             className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto px-4 sm:px-0"
           >
        ...
        <div className="w-full lg:w-[55%] h-[320px] sm:h-[400px] lg:h-[600px] flex items-center justify-center relative perspective-[2500px] mt-8 lg:mt-0 px-2 lg:px-0">
          <motion.div 
            className="relative w-full max-w-[340px] sm:max-w-[450px] lg:max-w-[650px] aspect-[16/11]"
          ...
          >
             ...
             <GlassCard className="w-full h-full !rounded-xl !border-white/10 !bg-[#0f1115]/90 flex flex-col shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)]">
                {/* Window Header */}
                <div className="h-8 lg:h-10 border-b border-white/[0.06] flex items-center justify-between px-3 bg-white/[0.02]">
                ...
                <div className="flex-1 flex overflow-hidden">
                   ...
                   <div className="hidden md:flex w-12 border-r border-white/[0.06] flex-col items-center py-3 gap-4 bg-white/[0.01]">
                   ...
                   {/* Main View */}
                   <div className="flex-1 bg-[#0a0c10] p-3 md:p-5 flex flex-col gap-3 md:gap-4">
                      <div className="flex justify-between items-end">
                         ...
                         <button className="bg-blue-600 text-white text-[10px] px-2.5 py-1 rounded-md font-medium flex items-center gap-1 hover:bg-blue-500 transition-colors">
                           <Plus size={10} /> <span className="hidden sm:inline">Sprint</span>
                         </button>
                      </div>
                      ...
                      <div className="flex gap-2 md:gap-3 h-full overflow-hidden">
                         {['Backlog', 'In Progress', 'Done'].map((col, i) => (
                           <div key={col} className={`flex-1 bg-white/[0.02] rounded-lg border border-white/[0.04] p-2 flex flex-col gap-2 ${i === 2 ? 'hidden sm:flex' : 'flex'}`}>
             ...
             >
                <GlassCard className="p-3 lg:p-4 bg-[#1e2029]/80 !border-white/10 !rounded-xl backdrop-blur-xl shadow-2xl">
             ...
             >
                <GlassCard className="p-3 lg:p-4 bg-[#111318]/90 !border-green-500/20 !rounded-xl shadow-2xl">
